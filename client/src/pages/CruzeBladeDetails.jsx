...
// Assets
import heroVideo from '../assets/Inner-Images/Cruze-Blade/green/front.png';
import colorSwatch from '../assets/Inner-Images/Cruze-Blade/green/front.png';
...
const CruzeBladeShowcase = () => {
  ...
  const colors = [
    { name: "Nebula Green", code: "#2ecc71", price: "$2,499" },
    { name: "Lunar Gray", code: "#95a5a6", price: "$2,399" },
    { name: "Solar Red", code: "#e74c3c", price: "$2,599" },
    { name: "Cosmic Black", code: "#2c3e50", price: "$2,699" },
    { name: "Stellar White", code: "#ecf0f1", price: "$2,549" }
  ];
  ...
  const galleryImages = [
    { id: 1, src: 'front.jpg', alt: 'Cruze Blade Front View' },
    { id: 2, src: 'gallery-2.jpg', alt: 'Cruze Blade Side View' },
    { id: 3, src: 'gallery-3.jpg', alt: 'Cruze Blade Dashboard' },
    { id: 4, src: 'gallery-4.jpg', alt: 'Cruze Blade Rear View' },
    { id: 5, src: 'gallery-5.jpg', alt: 'Cruze Blade Night Ride' }
  ];
      ...
      <section className="color-customizer">
          ...
          >
            {colors.map((color, index) => (
              <SwiperSlide key={index}>
                ...
                >
                  <div className="color-swatch" style={{ backgroundColor: color.code }} />
        ...
        <div className="color-preview">
          <motion.div 
            ...
            animate={{ 
              background: `linear-gradient(135deg, ${colors[selectedColor].code} 0%, #2c3e50 100%)`
            }}
