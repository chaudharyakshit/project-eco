...
export default function ScootyDetails() {
  ...
  const product = useMemo(
    () => ({
      ...
      currency: 'INR',
      shortDescription:
        'Electric scooter with 140 km range, dual disc brakes, and commuter‑first ergonomics.',
      ...
      variants: [
        ...
        },
       {
          ...
          sku: 'SPARKX-BLK-01',
          stock: 8,
          images: [bluefront, blueleft, blueright, blueside]
        },
        { 
          colorName: 'grey',
          colorHex: '#5b5151ff',
          sku: 'SPARKX-NBL-01',
          stock: 5,
          images: [greyfront, greyleft, greyright, greyside]
        },
